...
The contract does not prove real-world truth; it proves that validators reached a consensus outcome over a committed artifact. It does not resolve DNS rebinding or support arbitrary binary evidence. Downstream consumers must still verify the returned status and settlement event.
